...
public:
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        newShapeLabel = new QLabel(MainTab);
        newShapeLabel->setObjectName(QStringLiteral("newShapeLabel"));
        newShapeLabel->setGeometry(QRect(520, 520, 111, 16));
        newShapeComboBox = new QComboBox(MainTab);
        newShapeComboBox->setObjectName(QStringLiteral("newShapeComboBox"));
        newShapeComboBox->setGeometry(QRect(490, 540, 151, 22));
    ...
    void retranslateUi(QWidget *MainWindow)
    {
        ...
        newShapeLabel->setText(QApplication::translate("MainWindow", "New Shape Type", Q_NULLPTR));
