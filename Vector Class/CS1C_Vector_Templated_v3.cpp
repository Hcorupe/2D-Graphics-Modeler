...
int main() {
	...
	myDoubleVector.insert(myDoubleVector.begin() + 10, 99.7);

	// print vector
	print_vector(myDoubleVector);

	myDoubleVector.resize(5);
//	cout << myDoubleVector[13];
	...
	myDoubleVector.insert(myDoubleVector.begin() + 3, 99.6);

	// print vector
	print_vector(myDoubleVector);

	myDoubleVector.reserve(12);

	// print vector
	print_vector(myDoubleVector);

	myDoubleVector.insert(myDoubleVector.begin() + 3, 99.5);
